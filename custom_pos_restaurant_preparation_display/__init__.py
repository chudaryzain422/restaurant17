...
def _pos_restaurant_preparation_display_post_init(env):
    if env.ref('pos_restaurant.pos_config_main_restaurant', raise_if_not_found=False) and not env.ref('custom_pos_preparation_display.preparation_display_main_restaurant', raise_if_not_found=False):
        convert.convert_file(env, 'custom_pos_restaurant_preparation_display',
