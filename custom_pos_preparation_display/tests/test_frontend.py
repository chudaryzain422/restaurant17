...
class TestUi(TestPointOfSaleHttpCommon):
    ...
    def test_01_preparation_display(self):
        ...
        pdis = self.env['custom_pos_preparation_display.display'].create({
    ...
    def test_printer_and_order_display(self):
        ...
        preparation_order = self.env['custom_pos_preparation_display.order'].search([('pos_order_id', '=', order.id)], limit=1)
