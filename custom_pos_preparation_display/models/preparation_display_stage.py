...
class PosPreparationStage(models.Model):
    _name = 'custom_pos_preparation_display.stage'
    ...
    preparation_display_id = fields.Many2one('custom_pos_preparation_display.display', string="Preparation display", ondelete='cascade')
