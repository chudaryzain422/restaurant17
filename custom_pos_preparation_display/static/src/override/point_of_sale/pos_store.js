...
patch(PosStore.prototype, {
    ...
    async _processData(loadedData) {
        ...
        this.preparationDisplays = loadedData["custom_pos_preparation_display.display"];
    },
    ...
    async updateModelsData(models_data) {
        ...
        if ("custom_pos_preparation_display.display" in models_data) {
            this.preparationDisplays = models_data["custom_pos_preparation_display.display"];
            this._initializePreparationDisplay();
        }
    },
