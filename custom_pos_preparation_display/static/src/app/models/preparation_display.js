...
import { Orderline } from "@custom_pos_preparation_display/app/models/orderline";
import { Stage } from "@custom_pos_preparation_display/app/models/stage";
import { Category } from "@custom_pos_preparation_display/app/models/category";
import { deserializeDateTime } from "@web/core/l10n/dates";
import { Product } from "@custom_pos_preparation_display/app/models/product";
...
export class PreparationDisplay extends Reactive {
    ...
    async doneOrders(orders) {
        await this.orm.call(
            "custom_pos_preparation_display.order",
            "done_orders_stage",
    ...
    async resetOrders() {
        this.orders = {};
        this.rawData.orders = await this.orm.call(
            "custom_pos_preparation_display.display",
            "reset",
            [[this.id]],
            {}
        );
    ...
    exit() {
        window.location.href = "/web#action=custom_pos_preparation_display.action_preparation_display";
    }
}
