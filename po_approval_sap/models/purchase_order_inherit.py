...
class PurchaseOrderInherit(models.Model):
    ...
    def button_confirm(self):
        ...
        if response.status_code == 200 or  response.status_code == 201:
            ...
            message = f"Order Created in SAP with order id {self.name}."
    ...
    def get_auth_token(self):
        ...
        url = "https://sams4sed.sam.ae:50201/sap/opu/odata/SAP/API_PURCHASEORDER_PROCESS_SRV/A_PurchaseOrder?$filter=CreatedByUser eq 'VENDORPORTAL'&sap-client=130"
        headers = {
                'x-csrf-token': 'fetch'
            }
