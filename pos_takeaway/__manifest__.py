...
#############################################################################
{
    ...
    'depends': ['point_of_sale', 'pos_restaurant', 'custom_pos_preparation_display'],
    'data': [
    ...
    'assets': {
        'point_of_sale._assets_pos': [
            ...
            'pos_takeaway/static/src/xml/Screens/ProductScreen/ControlButton/OrderType.xml',
            ...
            'pos_takeaway/static/src/js/Screens/ProductScreen/ControlButton/OrderType.js',
        ],
    },
