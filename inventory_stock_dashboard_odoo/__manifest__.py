...
###############################################################################
{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'inventory_stock_dashboard_odoo/static/src/css/sales_dashboard.css',
            'inventory_stock_dashboard_odoo/static/src/js/dashboard.js',
            'inventory_stock_dashboard_odoo/static/src/js/sales_dashboard.js',
            'inventory_stock_dashboard_odoo/static/src/js/expacted_sales.js',
            'inventory_stock_dashboard_odoo/static/src/xml/inventory_dashboard_template.xml',
            'inventory_stock_dashboard_odoo/static/src/xml/Expected_sales_dashboard_template.xml',
